...
## More info about Create React App Boilerplate:

This project's front-end side was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
